...
<body
	background=<c:url value="/static/images/Football-field-grass_1920x1200_light.jpg" />>
	<div class="container">
		...
		<br> <img src="<c:url value="/static/images/allsports-3.jpg" />"
			alt="AllSports" width="420" />


		<h1 class="intro">
			<spring:message code="message.menu.presentation" />
		</h1>
